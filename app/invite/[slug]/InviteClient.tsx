...
// ─── Background Patterns ────────────────────────────────────────────────────
// Riau Melayu wajik (diamond) woven texture
...
/**
 * SongketBand — horizontal ornamental strip inspired by Riau songket wajik weave.
 * Used as top/bottom edge on cards and section dividers.
 */
...
/**
 * PucukRebungDivider — traditional Riau bamboo-shoot (pucuk rebung) motif
 * used as section separator. Chevron-tipped with center wajik accent.
 */
...
/**
 * WajikBadge — concentric diamond (wajik) badge as a prestige ornamental mark.
 */
...
// ─── Floating Particles (pre-computed to avoid hydration mismatch) ──────────
const PARTICLES = [
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      <div style={{
        ...
        color: C.white, width: '62px', height: '66px',
        borderRadius: '5px',
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        fontFamily: F.display, fontSize: '29px', fontWeight: 600,
...
export default function InviteClient({ guest }: { guest: Guest }) {
  ...
  if (!opened) return (
    <div style={{
      ...
      <div style={{ position: 'fixed', inset: 0, backgroundImage: bgWajik, zIndex: 0 }} />
        ...
        <div style={{
          ...
          <div style={{ padding: '40px 34px 38px', textAlign: 'center', position: 'relative' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '10px', marginBottom: '22px' }}>
              ...
              <div className="breathe"><WajikBadge size={28} /></div>
              <Diamond size={3} color={C.gold} style={{ opacity: 0.4 }} />
            </div>
  ...
  return (
    <div style={{ background: C.cream }} className="page-enter">
      ...
      <section className="reveal" style={{
        ...
        {/* Woven texture */}
        <div style={{ position: 'absolute', inset: 0, backgroundImage: bgWajik, zIndex: 0 }} />
        {/* Ambient glow orb */}
        <div style={{
        ...
        <div style={{ maxWidth: '480px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          {/* Arabic Bismillah */}
          <p style={{
            fontFamily: F.arabic, fontSize: '36px', color: C.burgundy,
            lineHeight: 2.1, marginBottom: '8px', marginTop: '-4px'
          }}>
          ...
          <p style={{
            ...
            textShadow: '0 2px 10px rgba(44,24,16,0.07)',
            marginBottom: '-4px',
          }}>
            Vanya
          </p>
          ...
          <p style={{ fontFamily: F.body, fontSize: '13px', color: C.textLight, letterSpacing: '2px', marginBottom: '44px' }}>
      ...
      <section className="reveal" style={{ ...S, textAlign: 'center' }}>
        ...
        {/* Guest name with underline accent */}
      ...
      <section className="reveal" style={{ background: C.white, padding: '68px 24px' }}>
        <div style={{ maxWidth: '480px', margin: '0 auto', textAlign: 'center' }}>
          ...
          {/* 1. 'Kami yang berbahagia' — now italic */}
          ...
          <div>
            ...
            {/* 2. Parents on separate lines, more prominent */}
          ...
          <div>
            ...
            {/* 3. Long name — reduced to 26px + nowrap to guarantee single line */}
            <p style={{
      ...
      <section className="reveal" style={{ paddingTop: '64px', paddingBottom: '68px' }}>
        ...
        <div style={{ position: 'relative', boxShadow: '0 4px 28px rgba(44,24,16,0.09)' }}>
        ...
        <div style={{ maxWidth: '480px', margin: '0 auto', padding: '28px 24px 0', textAlign: 'center' }}>
          ...
          <a
            href="https://maps.app.goo.gl/bxiGv4QxUE3u2bNPA"
      ...
      <footer style={{
        ...
        <div style={{ padding: '72px 24px 60px', textAlign: 'center', position: 'relative' }}>
          ...
          <div style={{ maxWidth: '480px', margin: '0 auto', position: 'relative' }}>
            ...
            {/* Couple names */}
            <p style={{ fontFamily: F.display, fontSize: 'clamp(36px, 10vw, 48px)', fontWeight: 300, letterSpacing: '2px', lineHeight: 1.05 }}>
              Vanya
            </p>
            ...
            <p style={{ fontFamily: F.display, fontSize: 'clamp(36px, 10vw, 48px)', fontWeight: 300, letterSpacing: '2px', lineHeight: 1.05, marginBottom: '40px' }}>
              Faiz
            </p>
